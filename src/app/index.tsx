...
import { createAccount } from "@/services/firebaseServices";
...
export default function Register() {
    ...
    return (
        <View style={styles.container}>
            ...
            <Button text="Criar conta" onPress={() => createAccount({name, email, password, passwordConfirm})} size={Length.medium}/>
        </View>
    )
}
